                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                           <form action="{{url('post-current')}}" method="POST" id="logForm">
                               
                                               {{ csrf_field() }}
                               
                                              <div class="form-label-group">
                                                <input type="text" name="whoshouldhegetitfrom" id="inputEmail" class="form-control" placeholder="Ումից պետք է ստանա " >
                                                <label for="inputEmail">Ումից պետք է ստանա  </label>   
                                              </div> 
                               
                                              <div class="form-label-group">
                                                <input type="text" name="whatshouldheget" id="inputPassword" class="form-control" placeholder="Ինչ պետք է ստանա">
                                                <label for="inputPassword">Ինչ պետք է ստանա</label> 
                                              </div>
                                              


                                             <div class="form-label-group">
                                                <input type="text" name="howmuchshouldIget" id="inputPassword" class="form-control" placeholder="Ինչ քանակությամբ պետք է ստանա">
                                                <label for="inputPassword">Ինչ քանակությամբ պետք է ստանա</label> 
                                              </div>

                                              <div class="form-label-group">
                                                <input type="date" name="whentogetit" id="inputPassword" class="form-control" placeholder="Երբ պետք  է ստանա">
                                                <label for="inputPassword">Երբ պետք  է ստանա  </label> 
                                              </div>
