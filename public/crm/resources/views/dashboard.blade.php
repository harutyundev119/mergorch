                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                          <form action="{{url('post-input')}}" method="POST" id="logForm">
                               
                                               {{ csrf_field() }}
                               
                                              <div class="form-label-group">
                                                <input type="text" name="fromwhomdidhegetit" id="inputEmail" class="form-control" placeholder="Ումից է ստացել " >
                                                <label for="inputEmail">Ումից է ստացել </label>   
                                              </div> 
                               
                                              <div class="form-label-group">
                                                <input type="text" name="whatdidheget" id="inputPassword" class="form-control" placeholder="Ինչ է ստացել">
                                                <label for="inputPassword">Ինչ է ստացել</label> 
                                              </div>
                                             ...
                                             <div class="form-label-group">
                                              ...
                                              <div class="form-label-group">
                                                <input type="date" name="whendidhereceiveit" id="inputPassword" class="form-control" placeholder="Երբ է ստացել  ">
                                                <label for="inputPassword">Երբ է ստացել  </label> 
                                              </div>
