    ...
    <body class="sb-nav-fixed">
        ...
        <thead>
            <tr>
                <th>Ում է տվել</th>
                <th>Ինչ է տվել </th>
                <th>Ինչ քանակությամբ</th>
                <th>Երբ է տվել </th>
                <th>Երբ պետք է ետ ստանա</th>
        ...
        <tbody>
         @foreach($alls as $all)
            <tr> 
                <td><center>{{ $all->towhomdidhegiveit }}</center></td>
                <td><center>{{ $all->whatdidhegive }}</center></td>
                <td><center>{{ $all->howmuch }}</center></td>
                <td><center>{{ $all->whendidhegiveit }}</center></td>
                <td><center>{{ $all->whentogetitback }}</center></td>
            </tr>
             @endforeach 
