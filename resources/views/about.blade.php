<!DOCTYPE html>
<html lang="{{$locale}}" onkeypress="return runScript(event)"ead>
  <head>
...
========================================================= -->
    ...
    <!-- =======================================================
                       BANER
========================================================= -->
    <section class="about_first">
        <div class="our_skils">

            <h1 class="osk">@lang('main.ourprinciples')</h1>
            <div class="container">
                <div class="row py-md-5">
                    <div class="col-lg-3 col-4 mb-sm-5 mb-3">
                        <img src="{{ asset('images/about/agreement .png')}}" alt="agreement">
                        <p class="about_p">  @lang('main.ourprinciplestext1') </p>
                    </div>
                    <div class="col d-none d-lg-block"></div>
                    <div class="col-lg-3 col-4 mb-sm-5 mb-3">
                        <img src="{{ asset('images/about/delivery.png')}}" alt="delivery">
                            <p class="about_p">
                                @lang('main.ourprinciplestext2') </p>
                    </div>
                    <div class="col d-none d-lg-block"></div>
                    <div class="col-lg-3 col-4 mb-sm-5 mb-3">
                        <img src="{{ asset('images/about/support.png')}}" alt="suuport">
                        <p class="about_p">@lang('main.ourprinciplestext3')</p>
                    </div>

                    <div class="col-lg-3 col-4  mb-sm-5 mb-3 offset-2">
                         <img src="{{ asset('images/about/premium.png')}}" alt="pemium">
                         <p class="about_p">@lang('main.ourprinciplestext4')</p>
                    </div>
                    <div class="col-lg-3 col-4 mb-sm-5 mb-3 offset-lg-2">
                        <img src="{{ asset('images/about/food-delivery.png')}}" alt="">
                        <p class="about_p"> @lang('main.ourprinciplestext5')</p>
                    </div>
                </div>
            </div>
        </div>
...
========================================================= -->
    <section class="aboutUs">
        <div class="container">
        <h1 class=" osk"> @lang('main.aboutus') </h1>
        <div class="col-lg-10 m-auto">
        <p>@lang('main.aboutustext1')</p>
        <p>@lang('main.aboutustext2')</p>
        <p>@lang('main.aboutustext4')</p>
        <p>@lang('main.aboutustext5')</p>
        <p>@lang('main.aboutustext6')</p>
    </div>
</div>
    </section>
          ...
          <div class="row justify-content-around footer-bot">
              <div class=" col-sm-4 mt-sm-0 mt-md-2">
                  <ul>
                      ...
                      <li class="footerItem"><a href="delivery">Առաքման պայմաններ</a></li>
