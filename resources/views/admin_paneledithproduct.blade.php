            ...
            <div id="layoutSidenav_content">
                <main>
                   ...
                   <form action="/addproduct" method="post" id="carform" enctype="multipart/form-data">
                    @csrf
                    Անուն:<input type="text" name="name" placeholder="Name" value="{{ $product->name }}" required>
                    <br>
                    <br>
                    Serial Number:<input type="number" name="serialnamber" placeholder="SerialNamber" required  value="{{ $product->code}}">
                    <br>
                    <br>
                    Գին:<input type="number" name="price" placeholder="Price"  value="{{ $product->price}}" required>
                    <br>
                    <br>
                    Նախկին գին:<input type="number" name="previous_price" placeholder="previous_price"
                     value="{{ $product->newprice }}" required>
                    <br>
                    <br>
                    Նկարագրություն:
                    <br>
                          <textarea name="editor1"  value="{{ $product->discrepshn }}"></textarea>
                        <script>
                    ...
                    <br>
                    <br>
                    Քանակ:<input type="number" name="quantity" placeholder="Quantity" value="{{ $product->quantity }}" required>
                    <br>
                    <br>
                    <br>
                    <label for="cars">Ընտրել լեզուն:</label>
                        <select id="cars" name="lang" form="carform" >
                          <option value="{{ $product->lang }}">Հայերեն</option>
                    ...
                    <label for="cars">Բաժին:</label>
                        <select id="cars" name="catigoric" form="carform">
                          <option value="{{ $product->catigoric }}">Հայերեն</option>
                    ...
                    <br>
                     <label for="cars">Ենթաբաժին:</label>
                        <select id="cars" name="subcatigoris" form="carform">
                             <option value="{{ $product->subcatigoris }}">{{ $product->subcatigoris }}</option>
                              @foreach($subcategorys as $subcategory)
                    ...
                    <br>
                       Բրենդ։ <input type="text" name="brend" placeholder="brend" value="{{ $product->brend }}" required>
                    <br>
                    <br>
                    <br>
