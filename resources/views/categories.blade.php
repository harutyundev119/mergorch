...
========================================================= -->
    <main class="category">
        <div class="title my-md-5 my-4">
            <h1>Լվացող Միջոցներ</h1>
        </div>
...
========================================================= -->
                    <aside class="sub-categories col-md-4 col-lg-3 mb-3 col-10 pl-0 mx-auto">
                        ...
                        <div class="list-group">
                            ...
                            <a href="product.html" class="list-group-item list-group-item-action">Հատակի համար</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Օճառ, հեղուկ օճառ</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Լոգարանի,զուգարանի
                                մաքրման միջոցներ</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Մաքրող փոշիներ և
                                հեղուկներ</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Լողակ,լուգա</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Սպիտակեցնող,լաքահանող
                                նյութեր,ժավել</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Ապակիները մաքրելու
                                հեղուկ </a>
                            <a href="product.html" class="list-group-item list-group-item-action">Լվացքի փոշի և գել</a>
                            <a href="product.html" class="list-group-item list-group-item-action">Սպասք լվանալու
                                միջոց</a>
                        </div>
                    </aside>
...
<!-- =======================================================
                    PROCUCTS
========================================================= -->
                    <div class="row col-md-8 col-lg-9 m-0">
                        <div class="col-md-6 col-lg-4">
                            <div class="productBox d-flex flex-column justify-content-between">
                                <a href="../../product/10/index.html" class="productBtn">
                                    <div class="discountText">Զեղչ</div>
                                    <div class="productImg">
                                        <img src="images/product/pyn10ma1.jpg" alt="«Наш сад» N1 500 մլ">
                                    </div>
                                    <div class="productText">
                                        <h6>«Наш сад» N1 500 մլ</h6>
                                    </div>
                                    <div class="productPrice d-flex justify-content-center">
                                        <span class="sale">430 Դր</span>
                                        <span class="price">300 Դր</span>
                                    </div>
                                </a>
                                <div class="d-flex justify-content-center align-items-center productBtnGroup">
                                    ...
                                    <div class="user_likes productBtn heart " data-id="10">
                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                    </div>
                                    <div class="add_bag productBtn shopBtn " data-code="5514">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="productBox d-flex flex-column justify-content-between">
                                <a href="../../product/13/index.html" class="productBtn">
                                    <div class="discountText">Զեղչ</div>
                                    <div class="productImg">
                                        <img src="images/product/jfl60ip5.jpg" alt="Սպասք լվանալու միջոց «Наш сад»  1լ">
                                    </div>
                                    <div class="productText">
                                        <h6>Սպասք լվանալու միջոց «Наш сад» 1լ</h6>
                                    </div>
                                    <div class="productPrice d-flex justify-content-center">
                                        <span class="sale">0 Դր</span>
                                        <span class="price">720 Դր</span>
                                    </div>
                                </a>
                                <div class="d-flex justify-content-center align-items-center productBtnGroup">
                                    <a href="../../product/13/index.html" class="productBtn">
                                    ...
                                    <div class="user_likes productBtn heart " data-id="13">
                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                    </div>
                                    <div class="add_bag productBtn shopBtn " data-code="5511">
                                        <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="productBox d-flex flex-column justify-content-between">
                                <a href="../../product/17/index.html" class="productBtn">
                                    <div class="discountText">Զեղչ</div>
                                    <div class="productImg">
                                        <img src="images/product/hw8azvz9.jpg" alt="«Fairy»  500 մլ">
                                    </div>
                                    <div class="productText">
                                        <h6>«Fairy» 500 մլ</h6>
                                    </div>
                                ...
                                <div class="d-flex justify-content-center align-items-center productBtnGroup">
                                    ...
                                    <div class="user_likes productBtn heart " data-id="17">
                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                    </div>
                                    <div class="add_bag productBtn shopBtn " data-code="5507">
                                        <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="productBox d-flex flex-column justify-content-between">
                                <a href="../../product/25/index.html" class="productBtn">
                                    <div class="discountText">Զեղչ</div>
                                    <div class="productImg">
                                        <img src="images/product/b44djt7d.jpg" alt="Սպասք լվանալու հեղուկ  «Fairy»  1լ">
                                    </div>
                                    <div class="productText">
                                        <h6>Սպասք լվանալու հեղուկ «Fairy» 1լ</h6>
                                    </div>
                                    <div class="productPrice d-flex justify-content-center">
                                        <span class="sale">0 Դր</span>
                                ...
                                <div class="d-flex justify-content-center align-items-center productBtnGroup">
                                    ...
                                    <div class="user_likes productBtn heart " data-id="25">
                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                    </div>
                                    <div class="add_bag productBtn shopBtn " data-code="5499">
                                        <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="productBox d-flex flex-column justify-content-between">
                                <a href="../../product/26/index.html" class="productBtn">
                                    <div class="discountText">Զեղչ</div>
                                    <div class="productImg">
                                        <img src="images/product/3z4rh3xm.jpg" alt="«Ariel Lenor» 450 գ. ավտոմատ">
                                    </div>
                                    <div class="productText">
                                        <h6>«Ariel Lenor» 450 գ. ավտոմատ</h6>
                                    </div>
                                    <div class="productPrice d-flex justify-content-center">
                                        <span class="sale">0 Դր</span>
                                        <span class="price">580 Դր</span>
                                    </div>
                                </a>
                                <div class="d-flex justify-content-center align-items-center productBtnGroup">
                                    <a href="../../product/26/index.html" class="productBtn">
                                    ...
                                    <div class="user_likes productBtn heart " data-id="26">
                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                    </div>
                                    <div class="add_bag productBtn shopBtn " data-code="5498">
                                        <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="productBox d-flex flex-column justify-content-between">
                                <a href="../../product/27/index.html" class="productBtn">
                                    <div class="discountText">Զեղչ</div>
                                    <div class="productImg">
                                        <img src="images/product/g0g2kx5w.jpg" alt="«Ariel» 1,35 կգ">
                                    </div>
                                    <div class="productText">
                                        <h6>«Ariel» 1,35 կգ</h6>
                                    </div>
                                ...
                                <div class="d-flex justify-content-center align-items-center productBtnGroup">
                                    ...
                                    <div class="user_likes productBtn heart " data-id="27">
                                        <i class="fa fa-heart" aria-hidden="true"></i>
                                    </div>
                                    <div class="add_bag productBtn shopBtn " data-code="5497">
                                        <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from www.tntesakan.am/am/categories/28/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 13:07:39 GMT -->
