...
========================================================= -->
    <div class="content clear">
        <div class="mineForgot clear ">
            <div class="col-md-6 center">
                <h3>Մոռացե՞լ եք գաղտնաբառը։</h3>
                <p>Գրեք Ձեր անձնական էջի էլեկտրոնային հասցեն։ Սեղմեք Շարունակել կոճակը, որպեսզի էլեկտրոնային փոստի
                    միջոցով ստանաք գաղտնաբառը։</p>
                <br />
                <form method="post" action="#">
                    <div class="form-group ">
                        <label for="usr">Էլ. Փոստ:<span class="red">*</span></label>
                        <input type="text" name="email" class="form-control" id="usr">
                    </div>
                    <input type="submit" value="Շարունակել" class="button">
                </form>
            </div>
        </div>
    </div>
...
<!-- Mirrored from www.tntesakan.am/am/login/forgotpassword/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 13:34:25 GMT -->
