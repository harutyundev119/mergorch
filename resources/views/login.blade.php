...
<body>
    ...
    <header>
                    ...
                    <nav class="navbar col-lg-12 col">
                        ...
                        <ul class="row col justify-content-between mb-0 align-items-center">
                            ...
                            <li class="login d-flex align-items-center justify-content-end py-2 ">
                                <a href="/login" class="d-flex align-items-center">Մուտք</a>
                                <span class="mx-1">/</span>
                                <a href="/signin"> Գրանցվել</a>
                            </li>
        ...
        <div class="subNavbar">
            ...
            <a href="contact" class="subNavbarBtn">Կապ</a>
            <a href="discount" class="subNavbarBtn">Ակցիաներ</a>
        </div>
    </header>

    <main class="py-5 loginRegistr">
        <div class="container">
            <div class="row">
                <div class="col-md-6 my-2">
                    <div class="registration">
                        <h2 class="text-center">Նոր բաժանորդ</h2>
                        <div class="d-flex justify-content-center align-items-center registrTitle">
                            <i class="fa fa-user-plus" aria-hidden="true"></i>
                            Գրանցվել </div>
                        <p>Անձնական էջի ստեղծումը կօգնի կատարել հետևյալ գործողությունները ավելի արագ (կարիք չկա ամեն
                            անգամ ներմաուծել հասցեն և կոնտակտային տվյալները), տեսնել պատվերի վիճակը, ինչպես նաև տեսնել
                            նախկինում կատարած պատվերները։ Դուք կարող եք, գնումների ընթացքում, կուտակել բոնուսային
                            միավորներ (որոնց միջոցով ևս կարելի է գնումներ կատարել), իսկ մշտական հաճախորդների համար
                            գործում է զեղչային համակարգ։</p>
                        <a href="signin.html" class="button">Գրանցվել</a>
                    </div>
                </div>
                <div class="col-md-6 my-2">
                    <div class="entranse">
                        <h2 class="text-center">Ես արդեն գրանցվել եմ</h2>
                        <div class="d-flex justify-content-center align-items-center registrTitle">
                            <i class="fa fa-user" aria-hidden="true"></i>
                            Մուտք </div>
                        <form method="post" action="{{url('post-login')}}">  {{ csrf_field() }}
                            <label for="email">Էլ. Փոստ:<span class="requiredStar">*</span></label>
                            <input type="email" name="email" id="email">

                            <label for="password">Գաղտնաբառ։<span class="requiredStar">*</span></label>
                            <input type="password" name="password" id="password">
                            <a href="forgotpassword.html">Մոռացե՞լ եք գաղտնաբառը?</a>

                            <button class="button mt-4">Մուտք</button>
                        </form>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from www.tntesakan.am/am/login/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 13:23:06 GMT -->
