...
========================================================= -->
  <section class="content">
    <div class="container">
      <div class="mainAbout clear">
        <h3>Առաքում և վճարում</h3>
        <b>Մենք ցանկանում ենք մատուցել Ձեզ որակյալ ծառայություն` առավելագույնս հարմարավետ և մատչելի պայմաններով:</b>
        <br /><br />
        <p>Այդ նպատակով tntesakan.com իրականացնում է Ձեր ապրանքների մատակարարումը Ձեր իսկ նշած հասցեով:
          Առաքման համար ընտրելով համապատասխան ապրանքներն անհրաժեշտ է նշել հետևյալ տեղեկատվությունը. </p>
        <ul>
          <li>Հասցե, ուր պետք է առաքվի ապրանքատեսակը,</li>
          <li>Պատվիրատուի տվյալները՝ հեռախոսահամար, անուն, ազգանուն, որոնց միջոցով Ձեզ հետ կապ կհաստատի կայքի
            ադմինիստրատորը և կտեղեկացնի պատվերի կարգավիճակի մասին:</li>
        </ul>
        <br />
        <b>1.Պատվերի առկայության դեպքում առաքումն իրականացվում է հետեւյալ եղանակներով՝</b><br />
        <br />
        <p>Առաքում Երևանում 24 ժամվա ընթացքում</p><br />
        <p>Առաքում մարզեր մեքենայով՝ 1-ից 2 օրվաը ընթացքում, նախապես պայմանավորվելով կայքի ադմինիստրատորի հետ:
          Մարզեր առաքման գումարը կախված է հեռավորությունից և կգանձվի տեղում առաքիչի կողմից:
        </p>
        <br />
        <b>2. Առաքման եղանակներն ու ժամկետները</b><br />
        <br />
        <p>Մենք աշխատում ենք ամեն օր` ժամը 09:00 - 22:00-ը: Առաքման ձգձգումը հնարավոր է անկանխատեսելի դեպքերի
          առկայության
          պարագայում, որոնք տեղի են ունեցել մեր կամքից անկախ, կամ պատվերի բացակայության դեպքում: Այդ դեպքում կայքի
          ադմինիստրատորը Ձեզ անպայման կտեղեկացնի առաքման ժամկետի փոփոխության մասին:</p><br />
        <b>3. Առաքման գնային քաղաքականությունը</b> <br />
        <br />
        <p>Երևանում 1 օրվա ընթացքում իրականացվող առաքումն արժե 600 դրամ:</p><br />
        <p>Սակայն եթե Ձեր պատվիրված իրերի ընդհանուր գումարը գերազանցում է 10000 դրամը, պատվերների առաքման համար դուք
          կվճարեք 300 դրամ: Ինչպես նաև, եթե Ձեր պատվիրված իրերի ընդհանուր գումարը գերազանցում է 20000 դրամը, առաքումը
          կկատարվի անվճար:</p><br />
        <p>Մեկ օրվա ընթացքում դեպի Հայաստանի մարզեր մեքենայով իրականացվող առաքումն արժե 1կմ-ի համար 100 դրամ հաշվարկով։
        </p><br />
        <p>Իսկ եթե առաքված պատվերն ինչ-ինչ պատճառով Ձեզ դուր չի գալիս և Դուք ցանկանում եք վերադարձնել այն, ապա այդ
          դեպքում
          պարզապես անհրաժեշտ է վճարել առաքման գումարը՝ անկախ պատվիրված ապրանքի գումարի չափից:</p><br />
      </div>
    </div>
  </section>
...
<!-- Mirrored from www.tntesakan.am/am/privacy/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 13:29:13 GMT -->
