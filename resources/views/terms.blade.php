  ...
  <section class="content">
    <div class="container">
      <div class="mainAbout clear">
        <h3> Օգտագործման պայմաններ</h3>
        <b>Խնդրում ենք ուշադիր կարդալ սույն կանոններն ու պայմանները:</b><br />
        <br />
        <p>Օգտագործելով տվյալ ինտերնետային կայքը, Դուք ընդունում եք, որ հասկացել եք և համաձայն եք ներքոհիշյալ պայմանների
          հետ: </p>
        <p>Եթե Դուք չեք համաձայնում սույն Օգտագործման պայմաններին, ապա չեք կարող օգտագործել այս կայքը: </p><br />
        <p>Դուք հաստատում եք, որ Ձեր տարիքը գերազանցում է 16 տարեկանը</p>
        <p>Դուք նաև հաստատում եք, որ ամբողջովին իրավունակ և գործունակ եք սույն օգտագործման պայմաններով սահմանված
          դրույթները,
          պայմանները, պարտավորությունները, հաստատումները,երաշխավորություններն ու հավաստիացումներն ընդունելու համար և
          պարտավոր եք ընդունել այս Օգտագործման պայմաններն ու առաջնորդվել դրանցով:
        </p>
        <br />
        <b>ԾԱՆՈՒՑՈՒՄ 16-ԻՑ ՓՈՔՐ ԵՐԵԽԱՆԵՐԻ ԵՎ ՆՐԱՆՑ ԾՆՈՂՆԵՐԻ ԿԱՄ ԽՆԱՄԱԿԱԼՆԵՐԻ ՀԱՄԱՐ</b><br />
        <br />
        <b>Տվյալ կայքը նախատեսված չէ 16 տարեկանից ցածր անձանց համար:</b><br />
        <br />
        <p>Եթե Ձեր տարիքը փոքր է 16-ից, սակայն ցանկանում եք կապ հաստատել tntesakan.am-ի հետ, դա կարող եք անել ՄԻԱՅՆ Ձեր
          ծնողի կամ օրինական խնամակալի միջոցով:</p>
      </div>
    </div>
  </section>
<!-- =======================================================
...
<!-- Mirrored from www.tntesakan.am/am/terms/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 13:29:14 GMT -->
